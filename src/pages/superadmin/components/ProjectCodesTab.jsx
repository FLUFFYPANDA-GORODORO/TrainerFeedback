...
const ProjectCodesTab = () => {
  ...
  const matchedCount = importPreview.filter(
    ...
    <div className="h-[calc(100vh-120px)] flex flex-col gap-6">
      ...
      >
        <ModalHeader>
          ...
          <ModalDescription>
            Upload a JSON file containing a list of codes.
          </ModalDescription>
            ...
            <div className="border rounded-md p-3 bg-muted/50 text-xs space-y-2 max-h-[200px] overflow-y-auto">
              <div className="flex justify-between font-medium">
                ...
                <div className="flex gap-3">
                  <span
                    className={
                      matchedCount === importPreview.length
                        ? "text-green-600"
                        : "text-orange-600"
                    }
                  >
              ...
              <div className="space-y-1">
                {importPreview.slice(0, 10).map((p, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <span
                      className={`truncate flex-1 ${p.isDuplicate ? "text-muted-foreground line-through" : ""}`}
                    >
                      {p.rawCode}
                    </span>
                    {p.collegeName && !p.isDuplicate && (
